...
- [string-pool-vs-heap.md](string-pool-vs-heap.md) - String pool fundamentals
- [string-intern-method.md](string-intern-method.md) - Using `.intern()` to force pool lookup
- [immutable-class-requirements.md](immutable-class-requirements.md) - Why strings are immutable

...
---
See also: [01-Concepts-Reference.md — Part 2: Sidecar Pattern diagram](../Must-Know/01-Concepts-Reference.md#2-sidecar-pattern-control-plane-vs-data-plane), [`Diagram-01-Sidecar-Pattern.drawio`](../Diagram-01-Sidecar-Pattern.drawio)

...
---
See also: [01-Concepts-Reference.md — Part 3: Security](../Must-Know/01-Concepts-Reference.md#3-security-mtls-and-zero-trust), [`Diagram-03-mTLS-Handshake.drawio`](../Diagram-03-mTLS-Handshake.drawio)
